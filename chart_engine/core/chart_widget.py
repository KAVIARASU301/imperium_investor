...
class CandlestickChart(QWidget):
    ...
    def __init__(
        ...
        self._watermark_color           = self.global_chart_settings.get("watermark_color",    "#6F7783")
        self._watermark_opacity         = self.global_chart_settings.get("watermark_opacity",  0.22)
        self._watermark_position        = self.global_chart_settings.get("watermark_position", "bottom_center")
        self._watermark_font_size       = self.global_chart_settings.get("watermark_font_size", 40)
        self._watermark_description_opacity = self.global_chart_settings.get("watermark_description_opacity", 0.16)
        self._watermark_description_font_size = self.global_chart_settings.get("watermark_description_font_size", 20)
    ...
    def _create_chart_view(self) -> None:
        ...
        self.chart_bridge.target_price_updated.connect(self.target_price_updated)
        self.chart_bridge.target_line_deleted.connect(self.target_line_deleted)
