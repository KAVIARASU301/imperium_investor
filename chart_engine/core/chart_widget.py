...
class CandlestickChart(QWidget):
    ...
    def __init__(
        ...
        self._current_up_color          = self.global_chart_settings.get("up_candle_color",   "#26a69a")
        self._current_down_color        = self.global_chart_settings.get("down_candle_color", "#ef5350")
        self._current_volume_up_color   = self.global_chart_settings.get("up_volume_color",   "#26a69a")
        self._current_volume_down_color = self.global_chart_settings.get("down_volume_color", "#ef5350")
