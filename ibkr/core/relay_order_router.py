...
2.  RelayOrderRouter wraps a live Any (or KiteClientWrapper) instance.
...
─────────────────────────────────────────
    from ibkr.core.relay_order_router import RelayOrderRouter, RelayConfig
...
class RelayOrderRouter:
    """
    Drop-in wrapper around a live Any (or KiteClientWrapper) that
    ...
    def __init__(
        self,
        kite_client,                    # Any or KiteClientWrapper instance
