...
def build_relay_client(raw_kite_client, api_key: str, access_token: str, token_manager):
    from ibkr.core.direct_order_router import DirectOrderRouter
    from ibkr.core.ip_manager import IPManager
    from ibkr.core.order_router import OrderRouteMode, OrderRouter
    from ibkr.core.relay_order_router import RelayConfigStore, RelayOrderRouter, RelayUnavailableError
