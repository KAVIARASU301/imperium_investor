...
class AlertSystemManager(QObject):
    ...
    @Slot(str)
    def refresh_alert_lines_for_symbol(self, symbol: str) -> None:
        """Backward-compatible alias used by main_window signal wiring."""
        self.sync_chart_lines_for_symbol(symbol)
