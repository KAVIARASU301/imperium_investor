...
class OpenPositionsTable(QWidget):
    ...
    def _setup_ui(self):
        ...
        # Connect the cell click signal for chart updates
    ...
    def _configure_table(self):
        ...
        header.setSectionResizeMode(2, QHeaderView.ResizeMode.ResizeToContents)  # Avg
        header.setSectionResizeMode(3, QHeaderView.ResizeMode.ResizeToContents)  # LTP
