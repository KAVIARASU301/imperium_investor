...
from src.gui_components.menu_bar import create_main_menu
...
class SwingTraderWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        self.main_splitter = QSplitter(Qt.Orientation.Horizontal, handleWidth=2, objectName="mainSplitter")
        ...
        left_panel_splitter = QSplitter(Qt.Orientation.Vertical, handleWidth=2, objectName="leftSplitter")
